...
public class MyList {
    ...
    void f2() throws Exception {
        ...
        // Otherwise, update pointers for insertion at the beginning
        newNode.next = head;
        head.pre = newNode;
        head = newNode;
        //------ End your code here-----------------------------------------------------------
    ...
    void f4() throws Exception {
        ...
        while (head != null && head.info.name.toLowerCase().contains("i")) {
            System.out.println("Removing phone: " + head.info.ID + "-" + head.info.name + "-" + head.info.price);
            head = head.next;
        }

        if (head == null) { // The entire list might have been removed
            return;
        }

        Node current = head;
        while (current.next != null) {
            if (current.next.info.name.toLowerCase().contains("i")) {
                System.out.println("Removing phone: " + head.info.ID + "-" + head.info.name + "-" + head.info.price);
