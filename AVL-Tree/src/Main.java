...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    System.out.println("Tree structure before addition:");
                    printTree(tree.root, "", true);
                    System.out.print("Enter element to add: ");
                    int addElement = scanner.nextInt();
                    tree.root = tree.insert(tree.root, addElement);
                    System.out.println("Element added.");
                    System.out.println("Tree structure after addition:");
                    printTree(tree.root, "", true);
                    break;
                case 2:
                    System.out.println("Tree structure before addition:");
                    ...
                    tree.root = tree.deleteNode(tree.root, deleteElement);
                ...
                case 3:
                    ...
                    Node result = search(tree.root, searchElement);
                    if (result != null) {
